  ...
  return (
    <div className="  bg-white px-10 py-10 w-120 h-90 rounded-2xl m-10 p-4 shadow-lg">
      <span className="flex justify-between">
        ...
        <a
          href="/estado"
          className={`inline-flex items-center ${colorStatus[estado]} font-medium   bg-green-200 rounded-full px-4 py-1`}
        >
          {" "}
          {estado}
        </a>
      ...
      <div className="flex flex-col-1 gap-16 justify-center mt-4">
        ...
        <span className="text-center">
          <h3 className="font-black">
            {entregado ? "✓" : numeroDiasRestantes}
          </h3>
          <h4 className="text-gray-500">
            {entregado ? "Entregado" : "Días rest."}
          </h4>
        </span>
      </div>
      ...
      <div className="flex justify-center gap-4 mt-12">
        <a
          href="/botton2"
          className="inline-flex items-center text-white font-medium bg-blue-500  rounded-xl px-6 py-2"
        >
          Ver Detalles
        </a>
        ...
        <a
          href="/tablero"
          className="inline-flex items-center text-black font-medium bg-white rounded-xl border-1 border-gray-300 px-6 py-2"
        >
          {tablero}
        </a>
      </div>
