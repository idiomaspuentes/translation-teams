      ...
      <div>
        <div className="flex justify-between">
          ...
          <div className="space-x-4">
            <button className="text-sm border border-gray-300 py-2.5 px-6 rounded-lg hover:bg-gray-50 cursor-pointer">
              Exportar
            </button>
            <button className="text-sm bg-blue-500 text-white py-2.5 px-6 rounded-lg hover:bg-blue-600 cursor-pointer">
              + Nueva tarea
            </button>
          </div>
        </div>
